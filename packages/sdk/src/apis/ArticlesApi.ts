...
export class ArticlesApi extends runtime.BaseAPI {
    ...
    /**
     */
    async createRaw(requestParameters: CreateRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ArticleDto>> {
        if (requestParameters.createArticleDto === null || requestParameters.createArticleDto === undefined) {
            throw new runtime.RequiredError('createArticleDto','Required parameter requestParameters.createArticleDto was null or undefined when calling create.');
        }
    ...
    /**
     */
    async findOneRaw(requestParameters: FindOneRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<ArticleDto>> {
